            ...
            <div className="overlay-container">
                ...
                <div className="overlay-content">
                    <div className="glob-centre-2" style={{ marginBottom: "2%" }}>
                        <h2 className="text-row-mn-2" style={{ margin: "0px", marginBottom: "1%" }}>Project Red has made a difference to the lives of more than 4000 girls through its multiple initiatives.</h2>
                    </div>
                    ...
                    <div style={{ borderTop: '2px solid white', width: '100%'}}></div>
                    <div class="content glob-centre-3" style={{ marginLeft: "8%" }}>
                        <h2 style={{ marginTop: '0px', marginBottom: "0px" }} className="text-row-mn">Logos of Partnerships :</h2>
                    </div>
